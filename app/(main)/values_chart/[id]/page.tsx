...
import { InputValuesChart } from '@/demo/components/Charts/InputValuesChart';
    ...
    return (
        <div className="grid">            
            ...
            {loading ? (
                ...
                <InputValuesChart id={chartInfo.id} title={chartInfo.title} subtitle={chartInfo.subtitle} refetchInterval={refetchInterval}/>
            }
            </div>
        </div>
    );
