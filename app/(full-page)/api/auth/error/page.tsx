...
const ErrorContent = () => {
    ...
    if (!mounted) {
        return <div className="w-full surface-900 py-8 px-5 sm:px-8 flex flex-column align-items-center border-round-3xl"
            style={{ borderRadius: '53px', boxShadow: '0 4px 20px rgba(0, 0, 0, 0.5)', minHeight: '400px' }}>
        ...
        <div className="w-full surface-900 py-8 px-5 sm:px-8 flex flex-column align-items-center border-round-3xl"
            ...
            <div className="flex flex-wrap gap-3 justify-content-center mt-3">
                <Button
                    ...
                    onClick={() => router.push('/')}
                    className="p-button-primary p-button-help"
                />
            </div>
        </div>
    );
