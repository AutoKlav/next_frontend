...
goog.exportSymbol('proto.autoklav.UpdateSensor', null, global);
 ...
 * @constructor
 */
proto.autoklav.UpdateSensor = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.autoklav.UpdateSensor, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.autoklav.UpdateSensor.displayName = 'proto.autoklav.UpdateSensor';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.autoklav.UpdateSensor.prototype.toObject = function(opt_includeInstance) {
  return proto.autoklav.UpdateSensor.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.autoklav.UpdateSensor} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.autoklav.UpdateSensor.toObject = function(includeInstance, msg) {
  var f, obj = {
    name: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.autoklav.UpdateSensor}
 */
proto.autoklav.UpdateSensor.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.autoklav.UpdateSensor;
  return proto.autoklav.UpdateSensor.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.autoklav.UpdateSensor} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.autoklav.UpdateSensor}
 */
proto.autoklav.UpdateSensor.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.autoklav.UpdateSensor.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.autoklav.UpdateSensor.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.autoklav.UpdateSensor} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.autoklav.UpdateSensor.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getName();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.autoklav.UpdateSensor.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.autoklav.UpdateSensor} returns this
 */
proto.autoklav.UpdateSensor.prototype.setName = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.autoklav.UpdateSensor.prototype.getMinvalue = function() {
 ...
 * @return {!proto.autoklav.UpdateSensor} returns this
 */
proto.autoklav.UpdateSensor.prototype.setMinvalue = function(value) {
 ...
 * @return {number}
 */
proto.autoklav.UpdateSensor.prototype.getMaxvalue = function() {
 ...
 * @return {!proto.autoklav.UpdateSensor} returns this
 */
proto.autoklav.UpdateSensor.prototype.setMaxvalue = function(value) {
